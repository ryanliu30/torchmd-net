...
def get_argparse():
    ...
    parser.add_argument('--use-pos', default=False, type=bool, help='If true, include the positions to GN')
    parser.add_argument('--use-derivative', default=False, type=bool, help='If true, augment the data using derivatives')
    parser.add_argument('--eta', default=False, type=bool, help='The eta used in finite stepping')
